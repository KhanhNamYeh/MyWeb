...
const Login = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      container.classList.add('auth-container-active');
    }, 100);
  }, []);
  ...
  return (
    <div className="auth-container">
      <div className="auth-box auth-login-box">
          ...
          <div className="auth-form-group">
            <div className="auth-input-container">
              <input
                ...
                required
              />
              <div className="auth-input-focus-border"></div>
            </div>
          </div>
        ...
        <div className="auth-other-signin-options">
          <div className="auth-other-signin-label">Or sign in with:</div>
          <div className="auth-signin-providers">
            <a href="/auth/google" className="auth-signin-provider-logo">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 533.5 544.3" className="auth-provider-logo">
            ...
            <a href="/auth/github" className="auth-signin-provider-logo">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="auth-provider-logo">
            ...
            <a href="/auth/gitlab" className="auth-signin-provider-logo">
              <svg fillRule="evenodd" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" className="auth-provider-logo">
            ...
            <a href="/auth/atlassian" className="auth-signin-provider-logo">
              <svg fill="none" viewBox="4 4 24 24" xmlns="http://www.w3.org/2000/svg" className="auth-provider-logo">
      ...
      <div className="auth-box auth-create-account-box">
